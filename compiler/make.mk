...
COMPILER_INCLUDE_FLAGS := -I$(VM_DIR) -I$(UTIL_DIR) -I$(VASQ_INCLUDE_DIR)
...
$(COMPILER_DEPS_FILE): $(COMPILER_SOURCE_FILES) $(COMPILER_HEADER_FILES) $(VM_HEADER_FILES) $(VASQ_HEADER_FILES)
	rm -f $@
